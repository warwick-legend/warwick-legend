  ...
  if ( fParticleToBias == 0 )
    {
      ...
      G4Exception("WLGDBiasChangeCrossSection(...)",
                  "exWLGD.01",
                  JustWarning,
                  ed);
    }
...
G4VBiasingOperation* 
WLGDBiasChangeCrossSection::ProposeOccurenceBiasingOperation(const G4Track*            track, 
                                                                              ...
                                                                              callingProcess)
{
  ...
  if (fpname.contains("mu-"))
     ...
     XStransformation = 10.0 * 1.68;  // specific for this, boost n,gamma by 68% for 77Ge from 76Ge
  else
...
void WLGDBiasChangeCrossSection::
